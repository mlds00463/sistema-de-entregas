...
-- permite escolher um motoqueiro online mesmo se ele estiver com outra chamada em aberto.
-- Se ele já saiu para a rua, a troca é bloqueada. Se ainda estiver apenas chamado/aceito,
-- a chamada antiga volta para pendente e a nova entrega passa a chamar esse motoqueiro.
